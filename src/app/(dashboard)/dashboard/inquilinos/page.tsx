  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 sm:mb-6">
        <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Inquilinos</h1>
        <Link
          ...
          <table className="w-full text-left">
            <thead className="bg-slate-50 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-600">
              <tr>
                ...
                <th className="px-4 py-3 text-sm font-medium text-slate-600 dark:text-slate-300">Email</th>
                <th className="px-4 py-3 text-sm font-medium text-slate-600 dark:text-slate-300">Teléfono</th>
                <th className="px-4 py-3 text-sm font-medium text-slate-600 dark:text-slate-300 w-20" />
              </tr>
            </thead>
            <tbody>
              {(list ?? []).map((i) => (
                <tr key={i.id} className="border-b border-slate-100 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/30">
